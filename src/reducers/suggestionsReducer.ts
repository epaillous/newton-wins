...
import { FETCH_SUGGESTION_TYPES_SUCCESS, INIT_SUGGESTION, RESET_ACTIVE_SUGGESTION } from '../actions/suggestions';
...
export default function suggestionsReducer(state: StateInterface = INITIAL_STATE, action: any) {
  switch (action.type) {
